...
diverse, inclusive, and healthy community where students can learn from each
other's work.
...
they deem inappropriate, threatening, offensive, or harmful. The maintainer has
the right to remove, edit, or reject comments, commits, code, issues, and pull
...
**private report**: contact the maintainer directly via their GitHub profile
[`@shiviancodes`](https://github.com/shiviancodes), or open a confidential issue
if private contact is unavailable. All complaints will be reviewed and
